...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Quiz = __webpack_require__(1);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(Route, { path: '/assessment', component: _Quiz2.default })
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Choice = __webpack_require__(159);

	var _Choice2 = _interopRequireDefault(_Choice);

	var _Score = __webpack_require__(160);
	...
	var quiz = __webpack_require__(218).questions.quiz;
	...
	var Quiz = function (_Component) {
	    ...
	    _createClass(Quiz, [{
	        key: 'selectedAnswer',
	        value: function selectedAnswer(option) {

	            var x = this.state.current_quiz.choices.filter(function (current) {
	            ...
	            this.setState({
	                score: [].concat(_toConsumableArray(this.state.score), [{ q: this.state.current_quiz.question, score: x[0].points }]),
	        ...
	        value: function render() {
	            ...
	            if (this.state.current < quiz.length) {
	                ...
	                var choices = this.state.current_quiz.choices.map(function (currentchoice) {

	                    return _react2.default.createElement(_Choice2.default, { key: currentchoice.answer, choice: currentchoice.answer, onChoiceSelect: _this2.selectedAnswer.bind(_this2), answer: choice });
	                });
	                ...
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'p',
	                            null,
	                            this.state.current_quiz.question
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                            { align: 'center' },
	                ...
	                return _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_Score2.default, { currentscore: this.state.score, quiz: quiz })
	                );
	            }
	        }
	    }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Choice = function (_React$Component) {
	  ...
	  function Choice() {
	    ...
	    return _possibleConstructorReturn(this, (Choice.__proto__ || Object.getPrototypeOf(Choice)).call(this));
	  }
	  ...
	  _createClass(Choice, [{
	    ...
	    value: function render() {
	      ...
	      for (var i = 0; i < answer.length; i++) {
	        if (choice == answer[i]) color = "#21c064";
	      }

	      // var color=this.state.active ? "green" :"white"

	      return _react2.default.createElement("input", { type: "button", style: { backgroundColor: color }, className: "choices", value: this.props.choice, onClick: this.handleClick.bind(this) });
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Score = function Score(props) {
	    var currentscore = props.currentscore,
	        quiz = props.quiz;
	    ...
	    for (var i = 0; i < props.currentscore.length; i++) {
	        ...
	        if (hash[currentscore[i].q] == undefined) hash[currentscore[i].q] = currentscore[i].score;else hash[currentscore[i].q] = currentscore[i].score;
	    }
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                { className: 'label label-success' },
	                'You scored ',
	                (totalscore / (quiz.length * 3) * 100).toFixed(2),
	                ' %'
	            )
	        ),
	        _react2.default.createElement(
...
/***/ (function(module, exports) {
	...
	var questions = exports.questions = {
	    ...
	    "quiz": [{
	        ...
	        "choices": [{ "answer": "India", "points": 2 }, { "answer": "China", "points": 3 }, { "answer": "USA", "points": 1 }]

	    }, {
	        "question": "Which is the most popular sport in the World ?",
	        "choices": [{ "answer": "Tennis", "points": 2 }, { "answer": "Soccer", "points": 3 }, { "answer": "Basketball", "points": 1 }]

	    }, {
	        "question": "Which is the most famous state in USA ?",
	        "choices": [{ "answer": "New York", "points": 3 }, { "answer": "California", "points": 2 }, { "answer": "Illinois", "points": 1 }]

	    }, {
	        "question": " By law, a driver who causes bodily harm to a child in a school crossing zone is subject to ?",
	        "choices": [{ "answer": "Imprisonment", "points": 2 }, { "answer": "Fines", "points": 2 }, { "answer": "Both", "points": 3 }]

	    }, {
	        "question": " You are allowed to drive on the left side of a multilane highway when you are ?",
	        "choices": [{ "answer": "Passing other vehicle", "points": 2 }, { "answer": "Turning left", "points": 1 }, { "answer": "Either of both", "points": 3 }]
